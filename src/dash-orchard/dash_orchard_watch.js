/* @ts-self-types="./dash_orchard_watch.d.ts" */
 ...
 * @returns {any}
 */
export function derive_watch_keys(seed, mainnet, account) {
    const ptr0 = passArray8ToWasm0(seed, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.derive_watch_keys(ptr0, len0, mainnet, account);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function trial_decrypt(fvk_hex, notes_js) {
    const ptr0 = passStringToWasm0(fvk_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.trial_decrypt(ptr0, len0, notes_js);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./dash_orchard_watch_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('dash_orchard_watch_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
